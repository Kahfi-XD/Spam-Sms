...
# Time Succes decompile : 2022-06-09 18:12:42.841857
...
print(f"▶ Subscribe channel gw dulu")
sleep(3)
os.system(f"xdg-open https://youtube.com/channel/UC6GPl9xMWL61NAXQb3HBrRw")
if "linux" in sys.platform.lower():
	os.system(
			"clear"
	)
...
creator = "Kahfi aja"
youtube = "BABANG KAHFI"
github = "Kahfi-XD"
link_yt = "https://youtube.com/channel/UC6GPl9xMWL61NAXQb3HBrRw"
...
banner = f"""  
 {white}▒▒▒▒▒▒▒▒▄▄▄▄▄▄▄▄▒▒▒▒▒▒ {white}[{red}SUBSCRIBE - LIKE - SHARE{white}]
 {white}▒▒█▒▒▒▄██████████▄▒▒▒▒{black}|{red}- {white}Creator{red}: {white}{creator}
 {white}▒█▐▒▒▒████████████▒▒▒▒{black}|{red}- {white}Youtube{red}: {white}{youtube}
 ▒▌▐▒▒█{red}█▄▀█████{red}█▀▄█{white}█▒▒▒{black}|{red}- {white}Github {red}: {white}{github}
...
class Main:
	...
	def main(self):
		...
		if sanz == "1" or sanz == "01":
			...
			# Ganti link fb nya v
			os.system("xdg-open https://www.instagram.com/hendar_scripter")
